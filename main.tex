...
\begin{exercise}
  ...
  \begin{proof}[Proof of \autoref{theorem: L is sound}]
	...
	\sigma \colon \bar{M} \to_{\Sigma^{(n)}_{1}} M
      \]
      \footnote{In a typical application $\sigma$ will be the
        canonical embedding associated to a fine structural ultrapower
        of $\bar{M}$.} Without further restrictions we might have that
    ...
    \begin{remark}
      Fine structure theory and it's later refinement
